...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{../figures/fig5_roc_multiplot.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{../figures/fig6_rolling_multiplot.png}
...
The ten-discipline ablation and SHAP analyses confirm that semantic similarity dominates the predictive signal universally. Figure~\ref{fig:ablation_all} shows the AUC drop when each feature is removed across all ten datasets. Semantic similarity dominates in every single case, with drops ranging from 0.189 (Osteosarcoma) to 0.540 (Political Participation). The second most important feature is temporal gap, which contributes meaningfully in Archaeology (drop 0.057), Fatigue Crack (drop 0.043), Osteosarcoma (drop 0.035), and Neuroblastoma (drop 0.032), reflecting the importance of citation aging effects in these disciplines. Prestige contributes most in Welfare State (drop 0.013) and Archaeology (drop 0.017). The three bibliographic coupling features (common references, Jaccard references, common citers) contribute negligibly across all ten disciplines.

To provide a detailed view of these dynamics within each discipline, Figures~\ref{fig:ablation_multi} and~\ref{fig:shap_multi} present the leave-one-out ablation drops and normalized SHAP feature importances for each dataset individually. These multiplots confirm that the dominance of semantic similarity and the secondary structural role of temporal gap and prestige hold consistently across all five broad disciplinary clusters.
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{../figures/fig7_ablation_multiplot.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{../figures/fig8_shap_multiplot.png}
