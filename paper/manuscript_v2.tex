...
\midrule
Logistic Regression & 0.8498 & 0.8740 & 0.7152 & 0.7679 & 0.9252 & 0.5829 & 0.5767 \\
Linear SVM & 0.8440 & 0.8704 & 0.6893 & 0.7548 & 0.9403 & 0.5440 & 0.5618 \\
Random Forest & 0.8835 & 0.8912 & 0.7894 & 0.8026 & 0.8461 & 0.7398 & 0.6101 \\
Gradient Boosting & \textbf{0.8861} & \textbf{0.8978} & \textbf{0.7919} & \textbf{0.8040} & \textbf{0.8441} & \textbf{0.7458} & \textbf{0.6122} \\
\bottomrule
\end{tabular}}
\end{table}

Gradient Boosting achieved the highest ROC-AUC (0.8861), significantly outperforming the linear baseline (Logistic Regression AUC 0.8498). This indicates that the engineered structural features contain non-linear interactions that are best captured by tree-based ensembles.
...
\textbf{Model} & \textbf{ROC-AUC} & \textbf{PR-AUC} & \textbf{F1} & \textbf{Accuracy} & \textbf{Precision} & \textbf{Recall} & \textbf{MCC} \\
\midrule
Logistic Regression & 0.9600 & 0.9654 & 0.9021 & 0.9064 & 0.9460 & 0.8621 & 0.8161 \\
Linear SVM & 0.9567 & 0.9634 & 0.8988 & 0.9031 & 0.9411 & 0.8601 & 0.8093 \\
Random Forest & 0.9578 & 0.9579 & 0.8941 & 0.8936 & 0.8902 & 0.8980 & 0.7872 \\
Gradient Boosting & \textbf{0.9744} & \textbf{0.9765} & \textbf{0.9189} & \textbf{0.9194} & \textbf{0.9250} & \textbf{0.9129} & \textbf{0.8389} \\
\bottomrule
\end{tabular}}
\end{table}

The performance on the OpenAlex dataset was exceptionally high, with Gradient Boosting achieving an ROC-AUC of 0.9744. The inclusion of semantic features and the rich structural data of OpenAlex provided a highly separable space for the models.
