"""
fetch_dimensions_environmental_engineering.py
---------------------------------
Fetches environmental engineering journal articles from Dimensions.ai (1975–2024)
using a single keyword search, year by year, and saves two outputs:

  1. Dimensions_environmental_engineering_1975_2024_raw.json.gz   — raw API response
  2. Dimensions_environmental_engineering_1975_2024.parquet       — processed: id, year, title,
                                                         abstract, reference_ids

Keyword: "environmental engineering" (searched in title and abstract)
...
raw_path = DATA_DIR / "Dimensions_environmental_engineering_1975_2024_raw.json.gz"
...
parquet_path = DATA_DIR / "Dimensions_environmental_engineering_1975_2024.parquet"
