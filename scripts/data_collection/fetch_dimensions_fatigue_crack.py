"""
fetch_dimensions_fatigue_crack.py
---------------------------------
Fetches fatigue crack journal articles from Dimensions.ai (1975–2024)
using a single keyword search, year by year, and saves two outputs:

  1. Dimensions_fatigue_crack_1975_2024_raw.json.gz   — raw API response
  2. Dimensions_fatigue_crack_1975_2024.parquet       — processed: id, year, title,
                                                         abstract, reference_ids

Keyword: "fatigue crack" (searched in title and abstract)
...
raw_path = DATA_DIR / "Dimensions_fatigue_crack_1975_2024_raw.json.gz"
...
parquet_path = DATA_DIR / "Dimensions_fatigue_crack_1975_2024.parquet"
