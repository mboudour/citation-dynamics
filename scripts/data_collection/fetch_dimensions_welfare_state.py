"""
fetch_dimensions_welfare_state.py
---------------------------------
Fetches welfare state journal articles from Dimensions.ai (1975–2024)
using a single keyword search, year by year, and saves two outputs:

  1. Dimensions_welfare_state_1975_2024_raw.json.gz   — raw API response
  2. Dimensions_welfare_state_1975_2024.parquet       — processed: id, year, title,
                                                         abstract, reference_ids

Keyword: "welfare state" (searched in title and abstract)
...
raw_path = DATA_DIR / "Dimensions_welfare_state_1975_2024_raw.json.gz"
...
parquet_path = DATA_DIR / "Dimensions_welfare_state_1975_2024.parquet"
