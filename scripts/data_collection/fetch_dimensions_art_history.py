"""
fetch_dimensions_art_history.py
---------------------------------
Fetches art history journal articles from Dimensions.ai (1975–2024)
using a single keyword search, year by year, and saves two outputs:

  1. Dimensions_art_history_1975_2024_raw.json.gz   — raw API response
  2. Dimensions_art_history_1975_2024.parquet       — processed: id, year, title,
                                                         abstract, reference_ids

Keyword: "art history" (searched in title and abstract)
...
raw_path = DATA_DIR / "Dimensions_art_history_1975_2024_raw.json.gz"
...
parquet_path = DATA_DIR / "Dimensions_art_history_1975_2024.parquet"
