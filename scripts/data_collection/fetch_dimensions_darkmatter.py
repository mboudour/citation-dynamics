"""
fetch_dimensions_darkmatter.py
-------------------------
Fetches dark matter journal articles from Dimensions.ai (1975–2024)
using a single keyword search, year by year, and saves two outputs:

  1. Dimensions_darkmatter_1975_2024_raw.json.gz   — raw API response (all fields)
  2. Dimensions_darkmatter_1975_2024.parquet       — processed: id, year, title,
                                                abstract, reference_ids (list of pub.* strings)

Keyword: "dark matter" (searched in title and abstract)
    ...
    └── computations/
        └── data_collection/
            ...
            └── data_collection_scripts/
                ...
                └── fetch_dimensions_darkmatter.py  ← this script
...
raw_path = DATA_DIR / "Dimensions_darkmatter_1975_2024_raw.json.gz"
...
parquet_path = DATA_DIR / "Dimensions_darkmatter_1975_2024.parquet"
