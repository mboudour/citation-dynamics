"""
Stage 3 — ML Training (OpenAlex v2)
=====================================
...
Outputs (saved to results/oa/):
  oa_cv_results_v2.json
  oa_shap_v2.json
  oa_ablation_v2.json
  oa_temporal_holdout_v2.json
"""
...
PAIRS_PATH = "/home/ubuntu/pipeline_v2/results/oa/oa_pairs_v2_sbert.parquet"
OUT_DIR    = "/home/ubuntu/pipeline_v2/results/oa"
LOG_FILE   = f"{OUT_DIR}/stage3_oa.log"
...
with open(f"{OUT_DIR}/oa_cv_results_v2.json", "w") as f:
...
with open(f"{OUT_DIR}/oa_shap_v2.json", "w") as f:
...
with open(f"{OUT_DIR}/oa_ablation_v2.json", "w") as f:
...
with open(f"{OUT_DIR}/oa_temporal_holdout_v2.json", "w") as f:
    json.dump(temporal_results, f, indent=2)
log("Temporal hold-out saved.")

log("Stage 3 OpenAlex complete.")
